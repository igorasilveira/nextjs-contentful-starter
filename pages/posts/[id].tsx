  ...
  return (
    <Layout>
      ...
      <article>
        ...
        <img className="w-full h-48 md:h-64 my-4 md:my-10 rounded-2lg object-cover shadow-lg" src={post.heroImage.url} alt={post.heroImage.context.custom.alt || post.title} />
        <div
